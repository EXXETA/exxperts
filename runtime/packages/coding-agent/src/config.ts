...
export const PACKAGE_NAME: string = pkg.name || "@exxeta/exxperts-runtime";
export const APP_NAME: string = piConfigName || "exxperts";
export const APP_TITLE: string = piConfigName ? APP_NAME : "exxperts";
export const CONFIG_DIR_NAME: string = pkg.piConfig?.configDir || ".exxperts";
...
// exxperts fork: share viewer not available yet
const DEFAULT_SHARE_VIEWER_URL = "https://exxeta.com/exxperts/session/";
...
// =============================================================================
// User Config Paths (~/.exxperts/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.exxperts/agent/) */
