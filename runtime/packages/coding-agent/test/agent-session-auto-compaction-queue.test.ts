...
import { type AssistantMessage, getModel } from "@exxeta/exxperts-ai";
...
describe("AgentSession auto-compaction queue resume", () => {
	...
	it("should trigger threshold compaction for error messages using last successful usage", async () => {
		...
		// A successful assistant message whose usage fills the model's own context window.
		// Sized from the catalogue value so a regenerated window cannot drop it below the
		// compaction threshold (window minus the reserve).
