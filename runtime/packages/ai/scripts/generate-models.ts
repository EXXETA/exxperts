...
async function generateModels() {
	...
	const codexModels: Model<"openai-codex-responses">[] = [
		...
		// GPT-5.6 family as served on the ChatGPT subscription endpoint (base
		// gpt-5.6 is API-only); costs mirror the openai API entries for wallet
		// estimates. The 5.6 family serves a larger 353k context on Codex.
		{
			id: "gpt-5.6-sol",
			name: "GPT-5.6 Sol",
			api: "openai-codex-responses",
