...
export const MODELS = {
	...
	"azure-openai-responses": {
		...
		"gpt-6-astra": {
			...
			baseUrl: "",
			reasoning: true,
			thinkingLevelMap: {"off":null,"xhigh":"xhigh","max":"max","minimal":"low"},
			input: ["text", "image"],
			cost: {
				input: 10,
				output: 50,
	...
	"openai": {
		...
		"gpt-6-luna": {
			...
			baseUrl: "https://api.openai.com/v1",
			reasoning: true,
			thinkingLevelMap: {"off":"none","xhigh":"xhigh","max":"max","minimal":"low"},
			input: ["text", "image"],
			cost: {
				input: 0.1,
				output: 0.5,
	...
	"openrouter": {
		...
		"deepseek/deepseek-v4-pro": {
			...
			input: ["text"],
			cost: {
				input: 0.8872260000000001,
				output: 1.7744520000000001,
				cacheRead: 0.07393549999999999,
				cacheWrite: 0,
			},
			contextWindow: 1048576,
			maxTokens: 384000,
