...
function buildParams(
	...
	const params: OpenAI.Chat.Completions.ChatCompletionCreateParamsStreaming = {
		...
		prompt_cache_key:
			...
			(cacheRetention === "long" && compat.supportsOpenAIPromptCacheRetention)
				? options?.sessionId
				: undefined,
		prompt_cache_retention: cacheRetention === "long" && compat.supportsOpenAIPromptCacheRetention ? "24h" : undefined,
	};
...
function getCompatCacheControl(
	...
	const ttl = cacheRetention === "long" && compat.supportsAnthropicCacheControlTtl ? "1h" : undefined;
...
function detectCompat(model: Model<"openai-completions">): ResolvedOpenAICompletionsCompat {
	...
	const supportsLongCacheRetention = !(isTogether || isCloudflareWorkersAI || isCloudflareAiGateway);
	...
	return {
		...
		supportsAnthropicCacheControlTtl: supportsLongCacheRetention,
...
function getCompat(model: Model<"openai-completions">): ResolvedOpenAICompletionsCompat {
	...
	return {
		...
		supportsOpenAIPromptCacheRetention:
			model.compat.supportsOpenAIPromptCacheRetention ??
			model.compat.supportsLongCacheRetention ??
			detected.supportsOpenAIPromptCacheRetention,
		supportsAnthropicCacheControlTtl:
			model.compat.supportsAnthropicCacheControlTtl ??
			model.compat.supportsLongCacheRetention ??
			detected.supportsAnthropicCacheControlTtl,
