...
- [Memory](memory.md): how room memory (Remember → Memorize → Review) and CLI memory work, the memory budget, what is stored where, and who approves it.
...
| Context | Command |
| --- | --- |
| Desktop app | none: open the app; it runs its own server and window |
